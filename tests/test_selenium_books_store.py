...
from books_shop_test.Pages.profile import ProfilePage
...
class TestBasicFlow(TestCase):
    ...
    def test_add_book_to_profile_flow(self):
        ...
        add_book_to_profile(self.driver, BOOK_NAME_1)

        self.driver.get('https://demoqa.com/profile')

        validate_and_remove_book(self.driver, BOOK_NAME_1)

    def test_two_add_book_to_profile_flow(self):
        login_as_registered_user(self.driver, USER)
        add_book_to_profile(self.driver, BOOK_NAME_1)
        add_book_to_profile(self.driver, BOOK_NAME_2)

        self.driver.get('https://demoqa.com/profile')

        validate_and_remove_book(self.driver, BOOK_NAME_1)
        validate_and_remove_book(self.driver, BOOK_NAME_2)
